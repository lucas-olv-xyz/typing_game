...
words_hard = [ 
    "ARCHIPELAGO",     # ARQUIPELAGO
    "LIBRARY",         # BIBLIOTECA
    "CATASTROPHIC",    # CATASTROFICO
    "DEVELOPMENT",     # DESENVOLVIMENTO
    "ELECTRONIC",      # ELETRONICO
    "PHOTOSYNTHETIC",  # FOTOSSINTETICO
    ...
    "VERISIMILITUDE",  # VEROSSIMILHANCA
    "WESTERN",         # WESTERNIANO
    "XYLOPHONIST",     # XILOFONISTA
    "YOUTUBERS",       # YOUTUBERS
    "ZOMBIFIED"        # ZUMBIFICADO
]

#------------------PERSONAGEM---------------------------------
player_img = pygame.image.load('assets/p1.png')
...
#-------------------------ANIMAÇÕES-------------------------------
enemy_type_1 = [
    pygame.image.load('assets/e1.png'),
    pygame.image.load('assets/e2.png'),
]
enemy_type_2 = [
    pygame.image.load('assets/e3.png'),
    pygame.image.load('assets/e4.png'),
]
enemy_type_3 = [
    pygame.image.load('assets/e5.png'),
    pygame.image.load('assets/e6.png'),
]
enemy_type_4 = [
    pygame.image.load('assets/e7.png'),
    pygame.image.load('assets/e8.png'),
]
player_idle_frames = [pygame.image.load('assets/p1.png'),pygame.image.load('assets/p2.png')]
enemy_idle_frames = [pygame.image.load('assets/e1.png'),pygame.image.load('assets/e2.png')]
...
def show_start_screen_with_difficulty():
    ...
    while start_running:
        ...
        instruction_text = font.render("choose difficulty:", True, (BLACK))
        easy_text = font.render("1 - Easy (Letters / Slow Monster)", True, (BLACK))
        medium_text = font.render("2 - Medium (Short Words/Medium Monster)", True, (BLACK))
        hard_text = font.render("3 - Hard (big words/fast monster)", True, (BLACK))
...
def Gamer_over_screen(score,wpm):
    ...
    while over_running:
        ...
        wpm_text = font.render(f"Words per minute: {wpm} WPM", True, BLACK)
        instruction_text = font.render("Press R to restart or Q to exit", True, BLACK)
